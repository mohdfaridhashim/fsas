...
<div class="container">
  <div class="header"><a href="#"><img src="" alt="Insert Logo Here" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #C6D580;display:block;"/></a> 
    <!-- end .header --></div>
      ...
      <li><a href="index.php?r=error">Link two</a></li>
      <li><a href="#">Link three</a></li>
      <li><a href="#">Link four</a></li>
      <span id="txt" style="text-align:right;display:block;font-weight:100;color:#FFFFFF;padding:4px;">test</span>
    </ul>
    <div class="contain">
    <!-- content -->
    <?php 
		$FSAS->get_controller($r);
	?>
    <!-- end .content -->
     </div>
  <div class="sidebar2">
...
<iframe src="http://localhost/ajax/demo2.htm" width="100%" height="500" frameborder="0"></iframe>
    <!-- end .sidebar2 --></div>
  <div class="footer">
